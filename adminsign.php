...
if (isset($_POST['asignup'])) {
	...
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO admin(name,email,password) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "')")) {
			$successmsg = "Successfully Registered! <a href='adminlog.php'>Click here to Login</a>";
...
<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="asignupform">
  ...
  <div class="container">
				...
				<fieldset>
					<legend>Sign Up</legend>
						...
						<input type="submit" name="asignup" value="Sign Up" />
				</fieldset>
			</form>
			...
			<span style='color:red'><?php if (isset($errormsg)) { echo $errormsg; } ?></span>
  				...
  				Already Registered? <a href="adminlog.php">Login Here</a>
